...
```
cmd/project-mcp-ref/main.go            # entrypoint: wires stdio transport
internal/projectmcpref/server.go        # NewServer() + tool handlers
internal/projectmcpref/server_test.go   # handler unit test + in-memory transport test
```
