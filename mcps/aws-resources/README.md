...
```
cmd/aws-resources/main.go            # entrypoint: wires stdio transport
internal/awsresources/server.go        # NewServer() + tool handlers
internal/awsresources/server_test.go   # handler unit test + in-memory transport test
```
